jQuery(document).ready(function ($) {
    ...
    function customize_multi_add_field(e) {
        ...
        $control.find('.customize_multi_fields').append('<div class="d-grid-auto-10 mb-15"><input type="text" value="" class="customize_multi_single_field" /><a href="#" class="button customize_multi_remove_field">X</a></div>');
    }
    ...
    $('.customize_multi_input').each(function () {
        ...
        if (multi_saved_value.length > 0) {
            ...
            $.each(multi_saved_values, function (index, value) {
                $this.find('.customize_multi_fields').append('<div class="d-grid-auto-10 mb-15"><input type="text" value="' + value + '" class="customize_multi_single_field" /><a href="#" class="button customize_multi_remove_field">X</a></div>');
            });
        }
    });
